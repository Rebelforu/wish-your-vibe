...
export const generateWishes = (name: string) => [
  // Special personalized quotes
  {
    wish: `Dear ${name}, on your special day, I want you to know how grateful I am to have you as a friend! 🎂 Your kindness, loyalty, and amazing personality make every day brighter. Happy Birthday buddy!`,
    gradient: "bg-gradient-primary",
    icon: <Heart className="w-8 h-8 text-celebration-pink" />
  },
  {
    wish: `${name}, you're not just a friend, you're family! ✨ May this birthday mark the beginning of your most incredible year yet, filled with success, happiness, and all your dreams coming true!`,
    gradient: "bg-gradient-secondary", 
    icon: <Sparkles className="w-8 h-8 text-celebration-purple" />
  },
  {
    wish: `Happy Birthday ${name}! 🎉 Your friendship means the world to me. May your special day be as awesome as you are, and may this new year bring you endless joy and unforgettable adventures!`,
    gradient: "bg-gradient-accent",
    icon: <Gift className="w-8 h-8 text-celebration-green" />
  },
  {
    wish: `${name}, another year of being absolutely amazing! 🌟 Your positive energy and genuine heart inspire everyone around you. Here's to celebrating YOU and all the wonderful things you bring to this world!`,
